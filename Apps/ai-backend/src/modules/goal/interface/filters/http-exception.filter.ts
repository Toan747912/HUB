...
export class HttpExceptionFilter implements ExceptionFilter {
    ...
    const req = ctx.getRequest<GoalRequestWithTrace & Request>();
  ...
  private normalize(exception: unknown): { status: number; error: ErrorEnvelope } {
    ...
    if (exception instanceof GoalVersionConflictError) {
      return {
    ...
    if (exception instanceof GoalValidationError || exception instanceof GoalStateTransitionError) {
      return {
